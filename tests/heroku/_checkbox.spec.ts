...
test(`able checkbox by CSS`,async({page})=>{
    ...
    await page.locator('#checkboxes > input[type=checkbox]:nth-child(3)').uncheck();
    ...
    await expect(page.locator('#checkboxes > input[type=checkbox]:nth-child(3)')).not.toBeChecked();
